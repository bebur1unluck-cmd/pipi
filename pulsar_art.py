...
st.title("Радиоизлучение пульсара PC1919")
st.caption("ДатаАрт визуализация профилей сигналов на основе стохастического шума.")

# Заглушка для динамического вывода графика (будет отрисован выше настроек)
plot_placeholder = st.empty()

# Добавление текстовой сноски с объяснением природы волн
st.info(
    "Каждая горизонтальная линия представляет собой последовательную запись "
    "радиоизлучения пульсара PC1919 за один полный оборот.\n\n"
    "Форма и пики отражают мгновенную мощность импульса. Центральные пики показывают "
    "момент, когда конус излучения звезды направлен строго на Землю.\n"
    "Смещение пиков всплески не идеальны и слегка сдвигаются по горизонтали из-за флуктуаций "
    "в плазмосфере звезды и эффектов межзвездной среды.\n"
    "Фоновая «зубчатость» - стохастический шум, состоящий из смеси аппаратных помех "
    "радиотелескопа и фонового космического радиоизлучения."
)
