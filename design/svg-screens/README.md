...
4. Для интерактивного прототипа создайте отдельные Frames 390x844 и поместите в них соответствующие SVG-экраны.
...
4. Во вкладке **Prototype** проставьте переходы по карте ниже.

> Важно: обычный SVG не хранит Figma prototype links. Поэтому сами экраны готовы как SVG, а кликабельные переходы нужно проставить в Figma вручную по карте переходов.
